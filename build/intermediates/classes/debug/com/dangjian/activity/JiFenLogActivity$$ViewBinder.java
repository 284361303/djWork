...
public class JiFenLogActivity$$ViewBinder<T extends com.dangjian.activity.JiFenLogActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131427524, "field 'jiFenLogRecyclerView'");
    target.jiFenLogRecyclerView = finder.castView(view, 2131427524, "field 'jiFenLogRecyclerView'");
    view = finder.findRequiredView(source, 2131427523, "field 'jiFenLogRefresh'");
    target.jiFenLogRefresh = finder.castView(view, 2131427523, "field 'jiFenLogRefresh'");
  }
  ...
  @Override public void unbind(T target) {
    ...
    target.jiFenLogRecyclerView = null;
    target.jiFenLogRefresh = null;
  }
}
