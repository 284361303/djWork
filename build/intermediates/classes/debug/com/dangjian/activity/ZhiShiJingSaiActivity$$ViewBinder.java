...
public class ZhiShiJingSaiActivity$$ViewBinder<T extends com.dangjian.activity.ZhiShiJingSaiActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131427737, "field 'jingSaiRecyclerView'");
    target.jingSaiRecyclerView = finder.castView(view, 2131427737, "field 'jingSaiRecyclerView'");
    view = finder.findRequiredView(source, 2131427736, "field 'jingSaiRefresh'");
    target.jingSaiRefresh = finder.castView(view, 2131427736, "field 'jingSaiRefresh'");
  }
  ...
  @Override public void unbind(T target) {
    ...
    target.jingSaiRecyclerView = null;
    target.jingSaiRefresh = null;
  }
}
