 ...
 * 青年工作标题详情页
 */
public class YouthWorkTitleDetailActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    @Bind(R.id.youthTitleDetail_recyclerView)
    RecyclerView youthTitleDetailRecyclerView;
    @Bind(R.id.youthTitleDetail_refresh)
    SwipeRefreshLayout youthTitleDetailRefresh;
    ...
    private LearingContentAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_youth_work_title_detail);
    ...
    private void getExtras() {
        ...
        if (extras != null) {
            ...
            if (activity.equals("UnionWorkActivity")) {       //工会工作
                titleRightTextTvRightName.setVisibility(View.VISIBLE);
                if ((Config.GH_ADMIN_ROLE != null && Config.GH_ADMIN_ROLE.equals("GH_ADMIN")) || Config.DW_ADMIN_ROLE.equals("DW_ADMIN")) {
                    titleRightTextTvRightName.setVisibility(View.VISIBLE);
                } else {
                ...
                titleRightTextTvRightName.setVisibility(View.VISIBLE);
                if ((Config.QN_AMIN_ROLE != null && Config.QN_AMIN_ROLE.equals("QN_ADMIN")) || Config.DW_ADMIN_ROLE.equals("DW_ADMIN")) {
                    titleRightTextTvRightName.setVisibility(View.VISIBLE);
                } else {
                    titleRightTextTvRightName.setVisibility(View.GONE);
                }
    ...
    private void initView() {
        ...
        youthTitleDetailRecyclerView.setLayoutManager(linearLayoutManager);
        youthTitleDetailRefresh.setOnRefreshListener(this);
        youthTitleDetailRefresh.setColorSchemeResources(android.R.color.holo_blue_bright,
                android.R.color.holo_green_light, android.R.color.holo_orange_light, android.R.color.holo_red_light);
        youthTitleDetailRecyclerView.addOnScrollListener(new LoadMoreListener());
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.titleRightText_tvRightName:       //发布
                ...
                iRelease.putExtra("activity", activity);
    ...
    private void upDataContentView() {
        adapter = new LearingContentAdapter(mContext, listData);
        initListener();
        youthTitleDetailRecyclerView.setAdapter(adapter);
        adapter.notifyDataSetChanged();
    }

    private void initListener() {
        adapter.setOnItemClickListener(new LearingContentAdapter.OnItemClickListener() {
            @Override
    ...
    private void getData() {
        Control.getNewsList(mContext, mCode, String.valueOf(pageIndex), pageSizes, new Callback.CommonCallback<String>() {
                ...
                try {
                    ...
                    if (status != null && status.equals("1")) {
                        ...
                        if (list != null && list.size() > 0) {
                            ...
                            youthTitleDetailRecyclerView.setVisibility(View.VISIBLE);
                        } else if (LoadingFlag.equals("1") && listData.size() >= 0) {
                            emptyLoadingLayoutLl.setVisibility(View.GONE);
                            youthTitleDetailRecyclerView.setVisibility(View.VISIBLE);
                        } else {
                            emptyLoadingLayoutLl.setVisibility(View.VISIBLE);
                            youthTitleDetailRecyclerView.setVisibility(View.GONE);
                        }
                        adapter.notifyDataSetChanged();
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                youthTitleDetailRefresh.setRefreshing(false);
